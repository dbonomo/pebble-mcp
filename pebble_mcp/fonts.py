...
SYSTEM_FONTS: list[SystemFont] = [
    ...
    SystemFont("FONT_KEY_GOTHIC_14", "gothic", 14, "regular", False, None, None,
    ...
    SystemFont("FONT_KEY_GOTHIC_28_BOLD", "gothic", 28, "bold", False, None, None,
    ...
    SystemFont("FONT_KEY_BITHAM_34_MEDIUM_NUMBERS", "bitham", 34, "medium", True,
               _CLOCK_NUMERALS, None, "Numbers-only per key name; digits + colon inferred."),
    ...
    SystemFont("FONT_KEY_BITHAM_42_MEDIUM_NUMBERS", "bitham", 42, "medium", True,
               _CLOCK_NUMERALS, None, "Numbers-only per key name; digits + colon inferred."),
    ...
    SystemFont("FONT_KEY_ROBOTO_BOLD_SUBSET_49", "roboto", 49, "subset", True,
               frozenset(_DIGITS + ":-°"), None,
    ...
    SystemFont("FONT_KEY_LECO_20_BOLD_NUMBERS", "leco", 20, "bold", True,
               _CLOCK_NUMERALS, None, "Numbers-only."),
    SystemFont("FONT_KEY_LECO_26_BOLD_NUMBERS_AM_PM", "leco", 26, "bold", True,
               _CLOCK_NUMERALS_AM_PM, None,
               "Numbers-only; _AM_PM variant adds A/M/P letters for the meridiem marker."),
    SystemFont("FONT_KEY_LECO_28_LIGHT_NUMBERS", "leco", 28, "light", True,
               _CLOCK_NUMERALS, None, "Numbers-only."),
    SystemFont("FONT_KEY_LECO_32_BOLD_NUMBERS", "leco", 32, "bold", True,
               _CLOCK_NUMERALS, None, "Numbers-only."),
    SystemFont("FONT_KEY_LECO_36_BOLD_NUMBERS", "leco", 36, "bold", True,
               _CLOCK_NUMERALS, None, "Numbers-only; DESIGN.md hero-value default (with LECO_42)."),
    SystemFont("FONT_KEY_LECO_38_BOLD_NUMBERS", "leco", 38, "bold", True,
               _CLOCK_NUMERALS, None, "Numbers-only."),
    SystemFont("FONT_KEY_LECO_42_NUMBERS", "leco", 42, "regular", True,
               _CLOCK_NUMERALS, None,
               "Numbers-only; DESIGN.md hero-value default (with LECO_36_BOLD)."),
    SystemFont("FONT_KEY_LECO_60_NUMBERS_AM_PM", "leco", 60, "regular", True,
               _CLOCK_NUMERALS_AM_PM, "emery",
               "Numbers-only, Emery and newer only per SDK docs."),
    SystemFont("FONT_KEY_LECO_60_BOLD_NUMBERS_AM_PM", "leco", 60, "bold", True,
               _CLOCK_NUMERALS_AM_PM, "emery",
               "Numbers-only, Emery and newer only per SDK docs."),
]
